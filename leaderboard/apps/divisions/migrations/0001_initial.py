# Generated by Django 3.1.4 on 2020-12-20 22:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='weightclass',
            constraint=models.UniqueConstraint(fields=('lower_bound', 'upper_bound'), name='unique_weight_range'),
        ),
        migrations.AddField(
            model_name='score',
            name='board',
        ...
        migrations.AddField(
            model_name='board',
            name='division',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='divisions.agedivision'),
        ),
        migrations.AddField(
            model_name='board',
            name='weight_class',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='divisions.weightclass'),
        ),
        migrations.AddConstraint(
